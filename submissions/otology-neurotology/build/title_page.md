...
*(This file is the **Title Page**. It is kept separate from the depersonalized `manuscript_body.md` per Otology & Neurotology submission requirements. No author-identifying information appears in the manuscript body file.)*
...
*(26 characters — within O&N 45-character limit including spaces.)*

## Article type

Original Article (computational prediction-model development and external validation)

## Authors

**Diego L Malpica Hincapie, MD**<sup>1,2,\*</sup>
ORCID: [0000-0002-2257-4940](https://orcid.org/0000-0002-2257-4940)

**Marian Farfan Fontalvo, MD**<sup>1</sup>
ORCID: [0000-0002-9910-6053](https://orcid.org/0000-0002-9910-6053)
...
*Phone and fax to be added prior to portal submission.*
...
- Body text: ~3,250 words (within O&N 3,500-word limit for Original Articles)
- Structured abstract: 249 words (within O&N 250-word limit)
- References: 24
- Tables in main manuscript: 2 (Tables 1 and 2)
- Figures: 4 (Figures 1–4)
- Supplemental Digital Content items: 3 (SDC 1 = TRIPOD 2015 checklist; SDC 2 = URI temporal modifier reference table; SDC 3 = Calibration summary table)

## Presentation at a meeting

Not applicable. No portion of this work has been presented at a scientific meeting.
...
The complete simulator (`barotrauma.v2`), automated test suite, calibration scripts, external-validation harnesses, and documentation are available under the MIT license at <https://github.com/strikerdlm/barotrauma_model>. Version tag `v2.2.1-manuscript` corresponds to the state described in this manuscript. A permanent DOI-assigned snapshot of the tagged release will be archived on Zenodo prior to publication and referenced in the final manuscript.

## Reporting guideline

The study is reported in accordance with the TRIPOD 2015 guideline (Transparent Reporting of a multivariable prediction model for Individual Prognosis Or Diagnosis) for prediction-model development and external validation. The completed TRIPOD 2015 checklist is provided as Supplemental Digital Content 1. TRIPOD+AI (Collins 2024) does not apply because no machine-learning component is used in the deployed prediction pipeline.
