...
No multivariable logistic regression model was fitted. At 23 denial events across 14 candidate predictors, the events-per-variable ratio of 1.6 falls substantially below the minimum of 10–20 required for stable maximum-likelihood estimation of logistic-regression coefficients.¹¹ Fitting a 14-variable model on 23 events would produce unreliable coefficient estimates and inflated apparent discrimination; individual flag associations are fully characterised by the univariable odds ratios reported above.
