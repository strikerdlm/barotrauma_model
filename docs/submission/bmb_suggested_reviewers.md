# Suggested Reviewers — BMB Submission
...
Long-time collaborator of the Doyle-Alper research group at the University of Pittsburgh. Co-author on the landmark Alper et al. 2023 PLOS ONE study "Dissecting eustachian tube dysfunction: From phenotypes to endotypes" (PMID 37074858) and multiple earlier papers on Eustachian tube function testing (Mandel 2016 FGE-per-swallow, Alper 2011 mastoid-volume buffering). Has deep quantitative expertise in the exact physiological mechanisms (middle-ear pressure regulation, ET opening mechanics, mastoid buffering) that parameterize the manuscript's model. No coauthorship with the submitting authors.

---

## Reviewer 2

**Name:** Cuneyt M. Alper, MD

**Affiliation:** Professor of Otolaryngology, University of Pittsburgh School of Medicine; Director, ACGME-accredited Pediatric Otolaryngology Fellowship Program; UPMC Children's Hospital of Pittsburgh, Pittsburgh, PA, USA

**Email:** `cuneyt.alper@chp.edu` (verified via PLOS ONE 2023 publication metadata)
**Department phone:** 412-647-2100 (Pitt Otolaryngology Eye & Ear Institute)

**Rationale for suggestion:**
Lead author of Alper 2020 (PMID 32176133) paired pre/post-BDET dataset and Alper 2011 (PMID 21271597) mastoid-volume log-normal prior, both of which directly parameterize the manuscript's biomechanical core. Runs a dedicated Eustachian tube dysfunction specialty clinic and has published extensively on the relationship between viral upper respiratory tract infections and otitis media. Uniquely qualified to evaluate both the clinical plausibility and the quantitative fidelity of the URI temporal modifier table and PET state machine. No coauthorship with the submitting authors.

---

## Reviewer 3

**Name:** Samir N. Ghadiali, PhD

**Affiliation:** Professor and Chair, Department of Biomedical Engineering, The Ohio State University; Professor of Internal Medicine, OSU Wexner Medical Center, Columbus, OH, USA

**Email:** `ghadiali.1@osu.edu` (publicly verified via OSU BME faculty page)
**Phone:** (614) 292-7742

**Rationale for suggestion:**
Author of the 2010 and 2019 Eustachian tube finite-element mechanics papers (PMIDs 20413236, 29395489) whose mechanical framework motivates the v2.2 lumped-parameter muscle-mechanics extension in the manuscript. Expertise spans computational biomechanics, fluid-structure interaction, and collapsible tube physiology. Well-positioned to assess the mathematical validity of the Hill-function aperture-collapse approximation and the rate-tightening formulation. No coauthorship with the submitting authors.
...
**Rationale for suggestion:**
Senior author of Morgagni 2010 (PMID 20824995) and Morgagni 2012 (PMID 22764614), two of the three independent Italian Air Force cohorts used for external validation in the manuscript. Has operational expertise in hypobaric-chamber training epidemiology and altitude physiology. Can assess whether the model's simulated point estimates (including the explained Morgagni 2010 gap) are consistent with the original cohort denominators and screening practices. No coauthorship with the submitting authors; the Colombian FAC data are entirely independent of the Italian cohorts.

---

## Reviewer 5

**Name:** Angelo Landolfi, MD, PhD
...
Morgagni and Landolfi authored the Italian Air Force cohorts used for external validation. This does **not** constitute a competing interest: (a) the manuscript uses their *published* aggregate data, not unpublished or confidential material; (b) the model validates positively against their findings (within observed CIs for two of three cohorts); (c) they are independent of the primary Colombian Aerospace Force data and calibration. Their expertise in operational chamber-training epidemiology is precisely why they are suitable reviewers.
...
## Editorial Manager comment-box text (copy-paste ready)

**Reviewer 1 (Swarts):**
> J. Douglas Swarts is a Research Assistant Professor at the University of Pittsburgh Department of Otolaryngology and a long-time collaborator of the Doyle-Alper middle-ear mechanics research group. He co-authored the 2023 PLOS ONE study on Eustachian tube dysfunction phenotypes/endotypes and earlier work on fractional gradient equalized per swallow and mastoid volume buffering — both core parameter sources for our model. He has deep quantitative expertise in middle-ear pressure regulation and no coauthorship with us.

**Reviewer 2 (Alper):**
> Cuneyt M. Alper is Professor of Otolaryngology at the University of Pittsburgh and runs a dedicated Eustachian tube dysfunction clinic. He is lead author of the paired pre/post-BDET dataset (Alper 2020) and the mastoid-volume study (Alper 2011) that parameterize our biomechanical core. He has published extensively on viral URI–otitis media relationships and is uniquely qualified to assess the clinical plausibility of our URI temporal modifier and PET state machine. No coauthorship with us.
