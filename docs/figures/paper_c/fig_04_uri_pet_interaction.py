...
opt = {
    ...
    "graphic": [
        {"type": "text", "left": "center", "bottom": 16, "z": 100,
         "style": {
    ...
    "grid": {"left": 80, "right": 130, "top": 50, "bottom": 70, "containLabel": True},
    "xAxis": {
        ...
        "axisTick": {"show": False},
        "axisLabel": {"fontFamily": FONT_FAMILY, "fontSize": 10, "color": "#000",
